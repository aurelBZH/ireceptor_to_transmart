...
class GrailsOAuth20Api extends DefaultApi20 {
	...
	public String getAccessTokenEndpoint() {
		return "https://transmart.i3lab.cloud:8445/transmart/oauth/token?grant_type=authorization_code&redirect_uri=https://transmart.i3lab.cloud:8445/transmart/oauth/verify";
	}

	@Override
	public String getAuthorizationUrl(OAuthConfig oAuthConfig) {
		return "https://transmart.i3lab.cloud:8445/transmart/oauth/authorize?response_type=code&client_id=api-client&client_secret=api-client&redirect_uri=https://transmart.i3lab.cloud:8445/transmart/oauth/verify";
	}
...
final String PROTECTED_RESOURCE_URL = "https://transmart.i3lab.cloud:8445/transmart/studies/MSY012/subjects";
