...
class GrailsOAuth20Api extends DefaultApi20 {
	...
	public String getAccessTokenEndpoint() {
		return "http://134.157.75.199:8080/transmart/oauth/token?grant_type=authorization_code&redirect_uri=http://134.157.75.199:8080/transmart/oauth/verify";
	}

	@Override
	public String getAuthorizationUrl(OAuthConfig oAuthConfig) {
		return "http://134.157.75.199:8080/transmart/oauth/authorize?response_type=code&client_id=api-client&client_secret=api-client&redirect_uri=http://134.157.75.199:8080/transmart/oauth/verify";
	}
...
final String PROTECTED_RESOURCE_URL = "http://134.157.75.199:8080/transmart/studies";
